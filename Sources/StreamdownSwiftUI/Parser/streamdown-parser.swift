...
public final class StreamdownParser {
    ...
    private func parseCodeFence(lines: [String], startIndex: Int) -> CodeFenceResult {
    ...
    private func isBulletListItem(_ line: String) -> Bool {
        let trimmed = line.trimmingCharacters(in: .whitespaces)
    ...
    private func parseBulletList(lines: [String], startIndex: Int) -> ListResult {
        var items: [String] = []
        var i = startIndex
    ...
    private func parseNumberedList(lines: [String], startIndex: Int) -> ListResult {
        var items: [String] = []
        var i = startIndex
    ...
    private func parseTable(lines: [String], startIndex: Int) -> TableResult {
    ...
    private func blockID(for index: Int) -> BlockID {
        BlockID(value: "block-\(index)")
    }

    private func withID(_ block: MarkdownBlock, id: BlockID) -> MarkdownBlock {
        switch block {
